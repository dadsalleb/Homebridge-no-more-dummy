...
module.exports = function(homebridge) {
	...
	homebridge.registerAccessory("homebridge-no-more-dummy", "NoMoreDummy", NoMoreDummy);
}


function NoMoreDummy(log, config) {
	this.log = log;
...
NoMoreDummy.prototype.getServices = function() {
...
NoMoreDummy.prototype._setValue = function(value, callback) {
